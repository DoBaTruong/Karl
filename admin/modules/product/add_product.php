...
if (isset($_POST['prd_name']) && isset($_POST['prd_price'])) {
    ...
    $check = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM product WHERE prd_name = '$name'"));
    if (isset($check)) {
        ...
        $status = mysqli_query($conn, "INSERT INTO product (cat_id, prd_name, prd_image, prd_imgSub, prd_color, prd_size, prd_brand, prd_price, prd_quantity, prd_details, prd_update) VALUES ($cat_id, '$name', '$img', '$prdSub', '$color', '$size', '$brand', $price, $qty, '$details', '$date')");
        if (isset($status)) {
...
<section class="breadcumb-area">
    ...
    <ul class="admin-breadcumb flex-start">
        ...
        <li class="breadcumb-item">Add Product</li>
    </ul>
</section>
<section class="add_page">
    ...
    ?>
    <form method="post" id="add_prd" class="flex-between" enctype="multipart/form-data">
        <div class="form-item">
            ...
            <div class="form-color">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="prd_color" id="prd_color" />
                    <div class="form-message"></div>
                </div>
            </div>
            <div class="form-group">
                <label for="prd_size">Size:</label>
                <input type="text" name="prd_size" id="prd_size" placeholder="X, M, L,..." />
                <div class="form-message"></div>
            </div>
            <div class="form-group">
                <label for="prd_quantity">Quantity:</label>
                <input type="number" step="0,01" name="prd_quantity" min="0" id="prd_quantity" />
                <div class="form-message"></div>
            </div>
            <div class="form-group">
                ...
                ?>
                <select data-toggle="movedata" data-parent=".form-item" data-target="#prd_brand" name="cat_id" id="cat_id" data-catego="<?php echo $stringData; ?>">
            ...
            <div class="form-image">
                <div class="image-item flex-between">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-message"></div>
                        <div class="file_preview flex-between"></div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label for="prd_details">Details:</label>
                <textarea class="ckeditor" name="prd_details" id="prd_details" cols="30" rows="10">
                    <p>Enter content under section corresponding, does not remove or change section default, please! </p>    
                    <h2>1. Information:</h2>
                    <h2>2. Details and Care:</h2>
